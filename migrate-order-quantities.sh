...
# The database schema has already been updated with cartonQuantity and articleQuantity fields
# This script is for reference - the changes are already applied via prisma db push
