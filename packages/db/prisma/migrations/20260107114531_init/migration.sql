...
-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('DRAFT', 'OPEN', 'ACTIVE', 'IN_PROGRESS', 'PAUSED', 'IN_REVIEW', 'COMPLETED', 'CANCELLED', 'EXPIRED');
-- CreateEnum
CREATE TYPE "RequestStatus" AS ENUM ('PENDING', 'APPROVED', 'REJECTED', 'CANCELLED');
-- CreateEnum
CREATE TYPE "SettingsChangeType" AS ENUM ('FIRST_NAME', 'LAST_NAME', 'EMAIL_ADDRESS', 'COMPANY_NAME', 'TAX_NUMBER');
-- CreateEnum
CREATE TYPE "AssignmentStatus" AS ENUM ('ASSIGNED', 'ACTIVE', 'PAUSED', 'COMPLETED', 'CANCELLED', 'OVERDUE');
-- CreateEnum
...
-- CreateEnum
CREATE TYPE "ActivityType" AS ENUM ('CONTAINER_UNLOADING', 'CONTAINER_LOADING', 'WRAPPING', 'REPACKING', 'CROSSING', 'LABELING', 'OTHER');
-- CreateEnum
...
CREATE TABLE "customer_activities" (
    ...
    "articleBasePrice" DECIMAL(10,2) DEFAULT 0,
    "isActive" BOOLEAN NOT NULL DEFAULT true,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
-- AddForeignKey
ALTER TABLE "assignments" ADD CONSTRAINT "assignments_customerActivityId_fkey" FOREIGN KEY ("customerActivityId") REFERENCES "customer_activities"("id") ON DELETE SET NULL ON UPDATE CASCADE;
-- AddForeignKey
...
-- AddForeignKey
ALTER TABLE "assignments" ADD CONSTRAINT "assignments_startedById_fkey" FOREIGN KEY ("startedById") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE CASCADE;
-- AddForeignKey
ALTER TABLE "assignments" ADD CONSTRAINT "assignments_pausedById_fkey" FOREIGN KEY ("pausedById") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE CASCADE;
-- AddForeignKey
ALTER TABLE "assignments" ADD CONSTRAINT "assignments_stoppedById_fkey" FOREIGN KEY ("stoppedById") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE CASCADE;
-- AddForeignKey
